package game.gambler.part.Input;
    ...
    MouseMotionListener, MouseWheelListener
{
    /**
        An invisible cursor.
    */
    public static final Cursor INVISIBLE_CURSOR =//光标 使用toolkit工具设置对应的鼠标光标样式
    ...
    /*
    * 键代码在java.awt.KeyEvent中定义。
    * 大多数代码（除了一些罕见的代码，如alt graph）都小于600。
    * */
    private static final int NUM_KEY_CODES = 600;

    //初始化一个所有键盘按键都包括的 的 动作数组
    ...
    private Point mouseLocation;//鼠标点击位置
    private Point centerLocation;//中心坐标
    private Component comp;//被管理的组件
    private Robot robot;
    ...
    */
    public InputManager(Component comp) {
        ...
        comp.addKeyListener(this);//将组建设置为输入管理对象
    ...
    */
    public void mapToKey(GameAction gameAction, int keyCode) {
        keyActions[keyCode] = gameAction;//将行为动作 赋值给
    }
    ...
    */
    public int getMouseX() {
        System.out.println(mouseLocation.x);
