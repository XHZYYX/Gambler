...
public class GameAction {
    ...
    */
    ...
    private static final int STATE_RELEASED = 0;//释放
    private static final int STATE_PRESSED = 1;//按下
    private static final int STATE_WAITING_FOR_RELEASE = 2;//等待释放

    private String name;//Action 操作名称
    private int behavior;//行为
    private int amount;//次数
