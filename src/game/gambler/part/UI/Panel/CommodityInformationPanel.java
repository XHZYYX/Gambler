...
public class CommodityInformationPanel extends JPanel {
    ...
    public CommodityInformationPanel(GoodBase good){
        super();
        this.good = good;
        this.good = DataManager.getInstance().getGoodBaseList().get(0);
    ...
    public void paint(Graphics graphics){
        ...
        graphics.drawImage(new ImageIcon("resource/images/good/"+good.getGood_imagePath()).getImage(),50,100,null);
    }
